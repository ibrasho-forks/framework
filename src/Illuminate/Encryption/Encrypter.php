...
class Encrypter implements EncrypterContract
{
    ...
    /**
     * Pad and use encrypt on the given value and input vector.
     *
     * @param  string  $value
     * @param  string  $iv
     * @return string
    ...
    protected function padAndEncrypt($value, $iv)
    {
        ...
        return openssl_encrypt($value, $this->method, $this->key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
    }
    ...
    {
        try {
            return openssl_decrypt($value, $this->method, $this->key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
        } catch (Exception $e) {
    ...
    public function setMethod($method)
    {
        ...
        $this->block = openssl_cipher_iv_length($this->method);
    }
